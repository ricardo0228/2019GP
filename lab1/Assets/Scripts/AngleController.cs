...
public class AngleController : MonoBehaviour
{
    ...
    [Range(0, 10)]
    public float maxMovingSpeed = 6.0f;
    [HideInInspector]
    ...
    public void Update()
    {
        ...
        _speed1 = Angle2Speed(SignedAngle(transform.right, _head_right_on_xz, transform.up),
                                maxMovingSpeed);
        _speed2 = Angle2Speed(SignedAngle(transform.right, _head_right_on_xy, -transform.forward),
                                maxMovingSpeed);
